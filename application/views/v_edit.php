            ...
            <div class="box-body no-padding">
              <table class="table">
                ...
                <tr>
                  ...
                  <td>
                    <a style="cursor: pointer;" title="" onclick="href='<?php echo base_url(('admin/hapus_rute/'.$s->id)); ?>'">Remove</a>
                    <a style="cursor: pointer;" title="" onclick="href='<?php echo base_url(('admin/edit_data/'.$s->id)); ?>'">Edit</a>
                  </td>
                </tr>
                <?php } ?>
              </table>
