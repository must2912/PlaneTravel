...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url('gedang/PlaneTravelCustomer/web/css/style.css') ?>">
...
<body>
			...
			<div id="horizontalTab">
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="include/order.php" method="post">
							<div class="from">
								<h3>Email</h3>
								<input type="text" name="email" class="city1" placeholder="Type Departure City" required="">
							</div>
							<div class="from">
								<h3>From</h3>
							...
							<div class="date">
								<div class="depart">
									<h3>Depart</h3>
									<input  id="datepicker" name="tanggal" type="text" value="mm/dd/yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
	...
	<!--script for portfolio-->
		<script src="<?php echo base_url('gedang/PlaneTravelCustomer/web/js/jquery.min.js')?>" type="text/javascript"></script>
		<script src="<?php echo base_url('gedang/PlaneTravelCustomer/web/js/easyResponsiveTabs.js')?>" type="text/javascript"></script>
		...
		<!--//script for portfolio-->
				<!-- Calendar -->
				<link rel="stylesheet" href="<?php echo base_url('gedang/PlaneTravelCustomercss/web/css/jquery-ui.css')?>"/>
				<script src="<?php echo base_url('gedang/PlaneTravelCustomer/web/js/jquery-ui.js')?>"></script>
				  <script>
						  $(function() {
